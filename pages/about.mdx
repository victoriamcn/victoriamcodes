...
### LIKES:
 `croissants` `fresh mangoes & kiwi` `90s-10s Rom-Coms`  `traveling` `upcycling thrift finds` `peanut butter``being cool` `public libraries` `black coffee` `Jane Austen` `bird watching`
